...
class TicTacToe:
    ...
    def make_move(self, square, letter):
        # return true if move is valid and make the move. return false if invalid
    ...
    def winner(self, square, letter):
        ...
        # check diagonals
        if square % 2 == 0:
            dia1 = [self.board[i] for i in [0, 4, 8]] # left-right diagonal
            if all([spot == letter for spot in dia1]):
                return True
            dia2 = [self.board[i] for i in [2, 4, 6]] # right-left diagonal
